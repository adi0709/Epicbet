...
This project contains automated tests using Playwright for the EpicBet Sports book platform, integrated with Allure for test reporting. The tests are executed within a Docker container, and Allure reports are generated after each test run, which can be viewed in a browser.
...
- **pages**: Directory containing elements and actions performed on each page of the platform.
